...
/*   Updated: 2016/10/31 14:25:16 by hmartzol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//			ft_putchar('\n');
			...
			data->mice.joystick = ft_point((x > (2 * window->size.x / 3))
				+ 2 * (x > (4 * window->size.x / 5))
				- (x < (window->size.x / 3)) - 2 * (x < (window->size.x / 5)),
				(y > (2 * window->size.y / 3))
				+ 2 * (y > (4 * window->size.y / 5))
				- (y < (window->size.y / 3)) - 2 * (y < (window->size.y / 5)));
		}
//		else
