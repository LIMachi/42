...
/*   Updated: 2016/11/08 17:45:09 by hmartzol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
							...
							const t_point hitbox, const t_button *prev_button)
{
	...
	size = 0;
	if (type == FTX_BUTTON_CLICK)
		size = sizeof(t_button_click);
	if (type == FTX_BUTTON_MAINTAIN)
		size = sizeof(t_button_maintain);
	if (type == FTX_BUTTON_TOGGLE)
		size = sizeof(t_button_toggle);
	if (type == FTX_BUTTON_SLIDER)
		size = sizeof(t_button_slider);
	if (type == FTX_BUTTON_TEXT_BOX)
...
void		*ftx_free_button(t_button *button)
{
	...
	if (button->type == FTX_BUTTON_TEXT_BOX &&
